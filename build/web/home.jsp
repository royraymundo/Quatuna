...
<html>
    ...
    <body>
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <form class="d-flex" action="#">
                                ...
                                <a class="btn btn-outline-success" href="ServletControl?accion=Carrito" type="submit"><i class='bx bx-cart'>(<label style="color:orange">${contador}</label>)</i></a>
                            </form>
                        </li>
                    </ul>

                    <ul class="navbar-nav btn-group my-2 my-lg-0" role="group">
                        <a style="color: white; cursor: pointer" class="dropdown-toggle btn btn-outline-success" data-bs-toggle="dropdown">
                        ...
                        <div class="dropdown-menu text-center dropdown-menu-right">
                            ...
                            <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#loginModal">${correo}</a>
        ...
        <div class="container mt-4">
            <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="imagenes/imagen4.jpg" id="miImagen1" width="500" height="500" class="d-block w-100" alt="...">
                    </div>
                    <div class="carousel-item">
                        <img src="imagenes/imagen2.jpg" id="miImagen2" width="500" height="500" class="d-block w-100" alt="...">
                    </div>
                    <div class="carousel-item">
                        <img src="imagenes/imagen8.jpg" id="miImagen3" width="500" height="500" class="d-block w-100" alt="...">
                    </div>
                </div>
            ...
            <div id="Separador1" width="500" height="500"><p></p></div>
            <div id="Separador1" width="500" height="500" ><h5 class="card-title">Lo mas vendido</h5></div>
            <div id="Separador1" width="500" height="500"><p></p></div>
