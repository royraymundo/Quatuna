...
<html>
    ...
    <body>       
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <a class="navbar-brand" href="#"><i>Qhatuna</i></a>
            <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                    <li class="nav-item active">
                        <a class="nav-link" href="ServletControl?accion=Nuevo"><i class="fas fa-home"></i> Home<span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="ServletControl?accion=listar"><i class="fas fa-plus-circle"></i> Ofertas del Dia</a>
                    </li>                   
                    <li class="nav-item">
                        <a class="nav-link" href="ServletControl?accion=listar"><i class="fas fa-plus-circle"></i> Seguir Comprando</a>
                    </li>                   
                    <li class="nav-item">
                        <a class="nav-link" href="ServletControl?accion=Carrito"><i class="fas fa-cart-plus"></i> Carrito</a>
                    </li>   
                </ul>                                             
                <ul class="navbar-nav btn-group my-2 my-lg-0" role="group">
                    <a style="color: white; cursor: pointer" class="dropdown-toggle" data-bs-toggle="dropdown">
                ...
                <table class="table tab-pane">
                    ...
                    <c:forEach var="p" items="${myCompras}">
                            <tr class="text-center">
                                ...
                                <td>${p.getEstado()}</td>                                                                                                       
                                <td>
                                    <a href="ServletControl?accion=verDetalle&idcompra=${p.getIdCompra()}">Ver Detalle</a>
                                </td>                                                                                                       
                            </tr>
                        </c:forEach>
                    </tbody>
